...
- 🎓 First-year engineering student specializing in **Big Data & Artificial Intelligence** at **ENSA Tétouan**, Morocco
- 🛠️ Learning by building — every concept I study turns into a real, end-to-end project
- 📊 Focused on the full data stack: ingestion → storage → orchestration → modeling
- 🌱 Currently deepening my skills in **Apache Airflow** (ETL & pipeline orchestration, IBM/Coursera track)
- 📫 Open to internships and collaborations in Data Engineering / ML Engineering

---

### 🚀 Currently Building — `nexagg`

A multi-service data aggregation platform, containerized end-to-end:

- 🐳 **Docker Compose** stack: PostgreSQL, MongoDB, and app services
- 🎮 Custom **Riot Games API** client (puuid → match history via Match-v5)
- ♟️ Custom **Chess.com API** client (archive-based game retrieval)
- 🗃️ Kaggle League of Legends dataset loaded into a typed, constrained, indexed PostgreSQL schema
